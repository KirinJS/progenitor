...
exports.format = function (src, dest, options) {
    progenitor.template(src, dest, progenitor.createOptionSelector(options));
}
...
exports.prompt = function (argv) {
    ...
    var userPrompts = !argv.generate && exists(promptsFile)  ? require(promptsFile).prompts : null;
    var header = userPrompts ? require(promptsFile).header : null;
